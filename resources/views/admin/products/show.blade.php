                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap  pt-6 pb-0">
                            ...
                            <div class="card-toolbar">
                                <a href="{{route('form')}}" class="btn btn-primary font-weight-bolder font-size-sm">
                                    Add New Products</a>
                            </div>
                        </div>
                            <div class="card-body">
                                                ...
                                                <tbody>
                                                  @foreach($product as $products)
                                                    <tr>
                                                        ...
                                                        <td>
                                                                <img src="{{asset($products->productImages)}}"
                                             ...
                                             <td>
                                                ...
                                                <span class="switch switch-outline switch-icon switch-primary">
                                                    <label>
                                                        ...
                                                        <td class="text-left">
                                                            <a href="{{url('/productById/' . $products->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
