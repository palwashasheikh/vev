                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Store Name</th><th>Store Address</th><th>Store Address2</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($stores as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->store_name }}</td><td>{{ $item->store_address }}</td><td>{{ $item->store_address2 }}</td>
                                        <td>
                                            <a href="{{ url('/admin/stores/' . $item->id) }}" title="View store"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/stores/' . $item->id . '/edit') }}" title="Edit store"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
