                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $service->name }} </td></tr><tr><th> Service Code </th><td> {{ $service->service_code }} </td></tr><tr><th> Service Detail </th><td> {{ $service->service_detail }} </td></tr>
                                </tbody>
                            </table>
                        </div>
