    ...
    <div class="d-flex flex-column-fluid">
     ...
     <form method="POST" action="{{ route('createStore') }}" accept-charset="UTF-8" class="form kt_form_1" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <input class="form-control" name="store_name" type="text" id="store_name" value="{{ isset($editstores->store_name) ? $editstores->store_name : ''}}" >
            ...
            <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input class="form-control"  id="location-text-box" name="store_address"   type="text"  value="{{ isset($editstores->store_address) ? $editstores->store_address : ''}}" >
         ...
         <div class="form-group row">
             <div class="col-lg-6">
                 ...
                 <textarea class="form-control" name="store_detail" type="text" id="store_detail" value="{{ isset($editstores->store_detail) ? $editstores->store_detail : ''}}" >
                 </textarea>
             ...
             <div class="col-lg-6">
                 ...
                 <select name="storetype" class="form-control" id="storetype" >
                     <option value="storetype">Select Category</option>
      ...
      <div class="col-lg-6">
          ...
          <input class="form-control" name="store_phone" type="text" id="store_phone" value="{{ isset($editstores->store_phone) ? $editstores->store_phone : ''}}" >
        ...
        <div class="col-lg-6">
            ...
            <input class="form-control" name="mobile" type="text" id="owner_mobile" value="{{ isset($editstores->owner_mobile) ? $editstores->owner_mobile : ''}}" >
         ...
         <div class="form-group row">
             <div class="col-lg-6 col-xl-6">
                 <label class="col-xl-3 col-lg-3 col-form-label ">Store Logo:</label>
                     <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                         <div class="image-input-wrapper" style="background-image: url({{('vev/content/stores/logo.png')}})"></div>
                         <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                             <i class="fa fa-pen icon-sm text-muted"></i>
                             <input type="file" name="storeLogo" accept=".png, .jpg, .jpeg" />
             ...
             <div class="col-lg-6 col-xl-6">
                 ...
                 <div class="image-input image-input-outline" id="kt_image_1">
                     <div class="image-input-wrapper " style="background-image: url({{('vev/content/stores/banner-default.jpg')}}); width: 600px;height: 200px"></div>
                     <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                         <i class="fa fa-pen icon-sm text-muted"></i>
