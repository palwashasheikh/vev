										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 py-5">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-3 font-weight-bold font-size-sm">More than <span id="dtcnt">400+</span> new products</span>
												</h3>
												<div class="card-toolbar">
													<a href="{{route('cproduct')}}" class="btn btn-success font-weight-bolder font-size-sm">
