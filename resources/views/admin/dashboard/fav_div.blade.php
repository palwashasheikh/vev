<div class="col-lg-6">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bolder text-dark">Most Favorite Services</h3>
											...
											<div class="card-body pt-0">
												...
												<div class="d-flex align-items-center mb-9 bg-light-success rounded p-5">
													...
													<div class="d-flex flex-column flex-grow-1 mr-2">
														<a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Food Panda</a>
													</div>
													<!--end::Title-->
													<!--begin::Lable-->
													<span class="font-weight-bolder text-success py-1 font-size-lg">+70%</span>
													<!--end::Lable-->
												</div>
												<!--end::Item-->
												<!--begin::Item-->
												<div class="d-flex align-items-center bg-light-warning rounded p-5 mb-9">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 mr-2">
														<a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Home Cleaning</a>
													</div>
													<!--end::Title-->
													<!--begin::Lable-->
													<span class="font-weight-bolder text-warning py-1 font-size-lg">+50%</span>
													<!--end::Lable-->
												</div>
												<!--end::Item-->
												<!--begin::Item-->
												<div class="d-flex align-items-center bg-light-danger rounded p-5 mb-9">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 mr-2">
														<a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Car Repair Service</a>
													</div>
													<!--end::Title-->
													<!--begin::Lable-->
												...
												<div class="d-flex align-items-center bg-light-info rounded p-5">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 mr-2">
														<a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Nike Shoes</a>
													</div>
													<!--end::Title-->
													<!--begin::Lable-->
