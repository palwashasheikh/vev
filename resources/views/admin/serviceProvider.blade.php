                                            ...
                                            <div class="card card-custom bg-success gutter-b" style="height: 150px">
                                                ...
                                                <span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
                                                    ...
                                                    <a href="{{route('addproduct')}}"
                                                       class="text-inverse-primary font-weight-bold font-size-lg mt-1">New Customer</a>
                                                </div>
                                            </div>
                                            <!--end::Tiles Widget 11-->
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-custom bg-warning gutter-b" style="height: 150px">
                                                ...
                                                <span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
                                                    ...
                                                    <a href="{{route('addProductDetails')}}"
                                                       class="text-inverse-primary font-weight-bold font-size-lg mt-1">Total Category</a>
                                                </div>
                                            </div>
                                            <!--end::Tiles Widget 11-->
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-custom bg-dark gutter-b" style="height: 150px">
                                                ...
                                                <span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
                                                    ...
                                                    <a href="{{route('addProductAttributes')}}"
                                                       class="text-inverse-primary font-weight-bold font-size-lg mt-1">Orders</a>
                                                </div>
                                            </div>
                                            <!--end::Tiles Widget 11-->
                                        </div>
